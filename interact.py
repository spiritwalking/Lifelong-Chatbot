...
def cli_demo():
    args = set_args()
    fix_seed(42)
    kwargs = {"max_history_len": args.max_history_len, "repetition_penalty": args.repetition_penalty,
              "temperature": args.temperature, "device": args.device, "max_len": args.max_len,
    ...
    # 聊天历史 [[query1, response1], [query2, response2]...]
    history = []
    print('开始和chatbot聊天')
